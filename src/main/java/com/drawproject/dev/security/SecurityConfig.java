    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
         http.csrf().disable()
                ...
                .requestMatchers("/api/auth/**").permitAll()
                 ...
                 .requestMatchers(HttpMethod.POST, "/api/v1/courses/student/report").hasRole(DrawProjectConstaints.INSTRUCTOR)
                 ...
                 .requestMatchers(HttpMethod.PUT, "/api/v1/staff/courses/report").hasAnyRole(
                         DrawProjectConstaints.STAFF, DrawProjectConstaints.ADMIN_ROLE)
                 .requestMatchers(HttpMethod.PUT, "/api/v1/courses/{id}/open").hasAnyRole(DrawProjectConstaints.INSTRUCTOR, DrawProjectConstaints.STAFF, DrawProjectConstaints.ADMIN_ROLE)
                 ...
                 .requestMatchers(HttpMethod.DELETE, "/api/v1/instructor/certificates/{certificateId}").hasAnyRole(DrawProjectConstaints.INSTRUCTOR, DrawProjectConstaints.STAFF, DrawProjectConstaints.ADMIN_ROLE)
                 ...
                 .requestMatchers(HttpMethod.DELETE, "/api/v1/instructor/artworks/{artworkId}").hasAnyRole(DrawProjectConstaints.STAFF, DrawProjectConstaints.ADMIN_ROLE, DrawProjectConstaints.INSTRUCTOR)
                 ...
                 .requestMatchers(HttpMethod.GET, "/api/v1/users/instructors").hasAnyRole(DrawProjectConstaints.STAFF, DrawProjectConstaints.ADMIN_ROLE)
